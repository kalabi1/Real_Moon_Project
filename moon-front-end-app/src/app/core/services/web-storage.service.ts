...
export class WebStorageService {
  ...
  public saveCompanyInfo(companyInfo) {
    globalVariables.companyInfo = companyInfo;
    window.localStorage.removeItem('companyInfo');
    window.localStorage.setItem('companyInfo', JSON.stringify(companyInfo));
    WebStorageService.setUserGloablData();
  }
  ...
  public static setUserGloablData() {
    ...
    globalVariables.companyInfo = JSON.parse(window.localStorage.getItem('companyInfo'));
  }
